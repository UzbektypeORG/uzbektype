...
export const uzbekLatinTexts: Record<Difficulty, string[]> = {
  easy: [
    ...
    "kitob daftar qalam ruchka maktab dars o'qituvchi talaba",
    "ona ota aka uka opa singil bobo buvi amaki xola",
    "non suv choy osh palov manti somsa shashlik tovuq baliq",
    "oq qora qizil ko'k yashil sariq kulrang oq-qora",
    ...
    "bahor yoz kuz qish issiq sovuq iliq salqin yomg'ir qor",
  ],
  medium: [
